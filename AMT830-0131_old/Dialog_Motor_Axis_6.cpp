// Dialog_Motor_Axis_6.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_6 dialog
#define TM_STATUS_CHECK		100
#define TM_POSITION_CHECK	200
#define TM_HOME_CHECK		300
#define TM_MOVE_CHECK		400
#define AXIS_NUM			5
CDialog_Motor_Axis_6::CDialog_Motor_Axis_6(CWnd* pParent /*=NULL*/)
	: CDialog(CDialog_Motor_Axis_6::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialog_Motor_Axis_6)
...
void CDialog_Motor_Axis_6::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialog_Motor_Axis_6)
...
BEGIN_MESSAGE_MAP(CDialog_Motor_Axis_6, CDialog)
	//{{AFX_MSG_MAP(CDialog_Motor_Axis_6)
	ON_WM_TIMER()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_6 message handlers
/*
void CDialog_Motor_Axis_6::OnTimer(UINT nIDEvent) 
{
...
*/
BOOL CDialog_Motor_Axis_6::OnInitDialog() 
{
...
void CDialog_Motor_Axis_6::Init_Group()
{
...
void CDialog_Motor_Axis_6::Init_Button()
{
	short	shBtnColor = 30;
	CString strTmp;

///////////////////////// 20120716
	if (m_str_axis_name == "Clip_Inset_Z")// || m_str_axis_name == "Loader_Transfer_X")
	{
...
void CDialog_Motor_Axis_6::Init_Label()
{

}

void CDialog_Motor_Axis_6::Init_Radio()
{

}

void CDialog_Motor_Axis_6::Init_Digit()
{

}

void CDialog_Motor_Axis_6::Init_Grid_Pos()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_6::Data_Apply()
{
	int i;
...
void CDialog_Motor_Axis_6::Data_Backup()
{
	int i;
...
int CDialog_Motor_Axis_6::Data_Comparison()
{
	int i;
...
void CDialog_Motor_Axis_6::Data_HistoryLog()
{
	int i;
	CString str_msg;
...
void CDialog_Motor_Axis_6::Data_Recovery()
{
	int i;
...
void CDialog_Motor_Axis_6::Data_Init()
{
	int i;
...
void CDialog_Motor_Axis_6::MotorStatusCheck()
{
...
void CDialog_Motor_Axis_6::MotorPositionCheck()
{
...
void CDialog_Motor_Axis_6::OnCellClick(WPARAM wParam, LPARAM lParam)
{
...
void CDialog_Motor_Axis_6::MotorMoveStepClear()
{
...
void CDialog_Motor_Axis_6::MotorCompletion(int nrow, int ncol)
{
	m_grid_motor_pos = (TSpread*)GetDlgItem(IDC_CUSTOM_MOTOR_POS);
...
int CDialog_Motor_Axis_6::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_6::MotorMovingExcution()
{
...
void CDialog_Motor_Axis_6::OnButtonControl(BOOL b_flag)
{
	
}


void CDialog_Motor_Axis_6::OnPaint() 
{
...
void CDialog_Motor_Axis_6::Init_Grid_Info()
{
	int   i, j;
	CString str_tmp;
...
/*
BOOL CDialog_Motor_Axis_6::DestroyWindow() 
{
...
void CDialog_Motor_Axis_6::OnDestroy() 
{
	Data_HistoryLog();
	Data_Apply();
...
void CDialog_Motor_Axis_6::OnBtnEmg() 
{
...
// **********************************************************************
LONG CDialog_Motor_Axis_6::OnUserLButtonDown(WPARAM wParam, LPARAM lParam)
{
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
LONG CDialog_Motor_Axis_6::OnUserLButtonUp(WPARAM wParam, LPARAM lParam)
{	
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
void CDialog_Motor_Axis_6::OnBtnHome() 
{
	CString strTmp;
...
void CDialog_Motor_Axis_6::OnBtnApply() 
{
	Data_HistoryLog();
	Data_Apply();
}
