...
#define WMU_CHILD_LBUTTON_DOWN	(WM_USER+550)
#define WMU_CHILD_LBUTTON_UP	(WM_USER+551)
...
public:
	...
	void SetIcon(UINT nID, UINT nIcon, UINT nIconAlign=BS_CENTER, UINT nIconDown=0);
