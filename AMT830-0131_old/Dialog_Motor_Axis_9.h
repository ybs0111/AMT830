#if !defined(AFX_DIALOG_MOTOR_AXIS_9_H__C43474D7_4BE9_4636_BC62_A134719AE6BE__INCLUDED_)
#define AFX_DIALOG_MOTOR_AXIS_9_H__C43474D7_4BE9_4636_BC62_A134719AE6BE__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Dialog_Motor_Axis_9.h : header file
//
...
class CDialog_Motor_Axis_9 : public CDialog
{
public:
...
public:
	...
	void	Init_Label();
	void	Init_Button();
	CDialog_Motor_Axis_9(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDialog_Motor_Axis_9)
	enum { IDD = IDD_MOTOR_AXIS_9 };
	...
	//{{AFX_VIRTUAL(CDialog_Motor_Axis_9)
	protected:
...
#endif // !defined(AFX_DIALOG_MOTOR_AXIS_9_H__C43474D7_4BE9_4636_BC62_A134719AE6BE__INCLUDED_)
