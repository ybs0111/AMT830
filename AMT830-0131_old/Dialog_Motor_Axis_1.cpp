	...
	: CDialog(CDialog_Motor_Axis_1::IDD, pParent)
{
	...
	COMI.Set_Motor_IO_Property(M_HS_F_STACKER_1, cmSD_EN, cmFALSE);
	COMI.Set_Motor_IO_Property(M_HS_B_STACKER_1, cmSD_EN, cmFALSE);
...
///////////////////////// 20120716
	else if (m_str_axis_name == "L_Attach_Z" || m_str_axis_name == "Clip_Buffer")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
	else if (m_str_axis_name == "P_Unload_X" || m_str_axis_name == "W_Buffer_1")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_LEFT);
	}
/////////////////////////
...
void CDialog_Motor_Axis_1::Data_Init()
{
	int i;
...
int CDialog_Motor_Axis_1::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_1::MotorMovingExcution()
{
	...
	switch(m_n_move_step)
	{
		case 0 :
			...
			else if (nRet == CTLBD_RET_ERROR)
			{
				...
				CTL_Lib.Alarm_Error_Occurrence(8880, CTL_dWARNING, COMI.mc_alarmcode);
				m_n_move_step = 130; 
			}
			else if (nRet == CTLBD_RET_SAFETY)
			{
