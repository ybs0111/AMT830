...
public:
	...
	int mn_allow_value[BD_MAX_MOTOR];			//이동 완료 후의 허용오차 범위 지정
	...
	////////// 2011.1024 아래 linear & coord move 명령은 현재 사용하지 않고 있다 /////////////
...
public:
	...
	int Start_Continue(int n_axis, double d_Speed);

	////////////////////////////////////////////////////////////////////////////////////////////////////////
	// 2011.1021 
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	int Debug_File_Create(int n_mode, CString s_msg);
	int FileSizeCheck(CString s_filename, long l_size, int n_check);

	////////////////////////////////////////////////////////////////////////////////////////////////////////
	int Set_MotInitSpeed(int n_Axis, double d_work);
	int Set_MotHomeSpeed(int n_Axis, double d_work, double d_accel, double d_decel);
	...
	int Check_MotPosRange(int n_Axis, double d_Distance, int n_Range);
	...
	int Get_MotIOSensor(int n_Axis, int n_MotSensor, int n_OnOff = 1);
...
///////////////////////////////////////////////////////////////////////////////////
	...
	int Set_TriggerSetConfig(int n_Axis, int n_Source, int n_Method);
	int Set_TrgContRegTable(long n_Axis, double* d_Source, long nCount);
	int Set_CmpTrgContStart(long n_Axis);
	int Set_CmpTrgContStop(long n_Axis);
///////////////////////////////////////////////////////////////////////////////////
