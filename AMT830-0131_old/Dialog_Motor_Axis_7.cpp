// Dialog_Motor_Axis_7.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_7 dialog
#define TM_STATUS_CHECK		100
#define TM_POSITION_CHECK	200
#define TM_HOME_CHECK		300
#define TM_MOVE_CHECK		400
#define AXIS_NUM			6
CDialog_Motor_Axis_7::CDialog_Motor_Axis_7(CWnd* pParent /*=NULL*/)
	: CDialog(CDialog_Motor_Axis_7::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialog_Motor_Axis_7)
...
void CDialog_Motor_Axis_7::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialog_Motor_Axis_7)
...
BEGIN_MESSAGE_MAP(CDialog_Motor_Axis_7, CDialog)
	//{{AFX_MSG_MAP(CDialog_Motor_Axis_7)
	ON_WM_TIMER()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_7 message handlers
/*
void CDialog_Motor_Axis_7::OnTimer(UINT nIDEvent) 
{
...
*/
BOOL CDialog_Motor_Axis_7::OnInitDialog() 
{
...
void CDialog_Motor_Axis_7::Init_Group()
{
...
void CDialog_Motor_Axis_7::Init_Button()
{
	short	shBtnColor = 30;
	CString strTmp;

	if (m_str_axis_name == "Unloader_Transfer_Z")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
	//////////////////////////// 20120716
	else if (m_str_axis_name == "M_Clip_Clamp")
	{
...
void CDialog_Motor_Axis_7::Init_Label()
{

}

void CDialog_Motor_Axis_7::Init_Radio()
{

}

void CDialog_Motor_Axis_7::Init_Digit()
{

}

void CDialog_Motor_Axis_7::Init_Grid_Pos()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_7::Data_Apply()
{
	int i;
...
void CDialog_Motor_Axis_7::Data_Backup()
{
	int i;
...
int CDialog_Motor_Axis_7::Data_Comparison()
{
	int i;
...
void CDialog_Motor_Axis_7::Data_HistoryLog()
{
	int i;
	CString str_msg;
...
void CDialog_Motor_Axis_7::Data_Recovery()
{
	int i;
...
void CDialog_Motor_Axis_7::Data_Init()
{
	int i;
...
void CDialog_Motor_Axis_7::MotorStatusCheck()
{
...
void CDialog_Motor_Axis_7::MotorPositionCheck()
{
...
void CDialog_Motor_Axis_7::OnCellClick(WPARAM wParam, LPARAM lParam)
{
...
void CDialog_Motor_Axis_7::MotorMoveStepClear()
{
...
void CDialog_Motor_Axis_7::MotorCompletion(int nrow, int ncol)
{
	m_grid_motor_pos = (TSpread*)GetDlgItem(IDC_CUSTOM_MOTOR_POS);
...
int CDialog_Motor_Axis_7::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_7::MotorMovingExcution()
{
...
void CDialog_Motor_Axis_7::OnButtonControl(BOOL b_flag)
{
	
}


void CDialog_Motor_Axis_7::OnPaint() 
{
...
void CDialog_Motor_Axis_7::Init_Grid_Info()
{
	int   i, j;
	CString str_tmp;
...
/*
BOOL CDialog_Motor_Axis_7::DestroyWindow() 
{
...
void CDialog_Motor_Axis_7::OnDestroy() 
{
	Data_HistoryLog();
	Data_Apply();
...
void CDialog_Motor_Axis_7::OnBtnEmg() 
{
...
// **********************************************************************
LONG CDialog_Motor_Axis_7::OnUserLButtonDown(WPARAM wParam, LPARAM lParam)
{
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
LONG CDialog_Motor_Axis_7::OnUserLButtonUp(WPARAM wParam, LPARAM lParam)
{	
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
void CDialog_Motor_Axis_7::OnBtnHome() 
{
	CString strTmp;
...
void CDialog_Motor_Axis_7::OnBtnApply() 
{
	Data_HistoryLog();
	Data_Apply();
}
