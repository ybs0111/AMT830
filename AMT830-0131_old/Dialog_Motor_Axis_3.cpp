// Dialog_Motor_Axis_3.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_3 dialog
#define TM_STATUS_CHECK		100
#define TM_POSITION_CHECK	200
#define TM_HOME_CHECK		300
#define TM_MOVE_CHECK		400
#define AXIS_NUM			2
CDialog_Motor_Axis_3::CDialog_Motor_Axis_3(CWnd* pParent /*=NULL*/)
	: CDialog(CDialog_Motor_Axis_3::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialog_Motor_Axis_3)
...
void CDialog_Motor_Axis_3::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialog_Motor_Axis_3)
...
BEGIN_MESSAGE_MAP(CDialog_Motor_Axis_3, CDialog)
	//{{AFX_MSG_MAP(CDialog_Motor_Axis_3)
	ON_WM_TIMER()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_3 message handlers
/*
void CDialog_Motor_Axis_3::OnTimer(UINT nIDEvent) 
{
...
*/
BOOL CDialog_Motor_Axis_3::OnInitDialog() 
{
...
void CDialog_Motor_Axis_3::Init_Group()
{
...
void CDialog_Motor_Axis_3::Init_Button()
{
	short	shBtnColor = 30;
	CString strTmp;

	if (m_str_axis_name == "Unloader_Tray_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_LEFT);
	}
///////////////////////// 20120716
	else if (m_str_axis_name == "Vision1_Z")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_DN);
	}
	else if (m_str_axis_name == "P_Unload_Z")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
	else if (m_str_axis_name == "W_Buffer_3")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_LEFT);
	}
...
/////////////////////////
	...
	else if (m_str_axis_name == "ROBOT Z")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
	else
...
void CDialog_Motor_Axis_3::Init_Label()
{

}

void CDialog_Motor_Axis_3::Init_Radio()
{

}

void CDialog_Motor_Axis_3::Init_Digit()
{

}

void CDialog_Motor_Axis_3::Init_Grid_Pos()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_3::Data_Apply()
{
	int i;
...
void CDialog_Motor_Axis_3::Data_Backup()
{
	int i;
...
int CDialog_Motor_Axis_3::Data_Comparison()
{
	int i;
...
void CDialog_Motor_Axis_3::Data_HistoryLog()
{
	int i;
	CString str_msg;
...
void CDialog_Motor_Axis_3::Data_Recovery()
{
	int i;
...
void CDialog_Motor_Axis_3::Data_Init()
{
	int i;
...
void CDialog_Motor_Axis_3::MotorStatusCheck()
{
...
void CDialog_Motor_Axis_3::MotorPositionCheck()
{
...
void CDialog_Motor_Axis_3::OnCellClick(WPARAM wParam, LPARAM lParam)
{
...
void CDialog_Motor_Axis_3::MotorMoveStepClear()
{
...
void CDialog_Motor_Axis_3::MotorCompletion(int nrow, int ncol)
{
	m_grid_motor_pos = (TSpread*)GetDlgItem(IDC_CUSTOM_MOTOR_POS);
...
int CDialog_Motor_Axis_3::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_3::MotorMovingExcution()
{
...
//	}
	...
	switch(m_n_move_step)
	{
		case 0 :
			...
			if (nRet == CTLBD_RET_GOOD)
			{
				sprintf(st_msg.c_normal_msg, "[" + m_str_cmd_motor + "] Motor start transfer.");
				st_handler.cwnd_list->PostMessage(WM_LIST_DATA, 0, NORMAL_MSG);  // 동작 완료 출력 요청
				m_n_move_step = 10;
			}
...
void CDialog_Motor_Axis_3::OnButtonControl(BOOL b_flag)
{
	
}


void CDialog_Motor_Axis_3::OnPaint() 
{
...
void CDialog_Motor_Axis_3::Init_Grid_Info()
{
	int   i, j;
	CString str_tmp;
...
/*
BOOL CDialog_Motor_Axis_3::DestroyWindow() 
{
...
void CDialog_Motor_Axis_3::OnDestroy() 
{
	Data_HistoryLog();
	Data_Apply();
...
void CDialog_Motor_Axis_3::OnBtnEmg() 
{
...
// **********************************************************************
LONG CDialog_Motor_Axis_3::OnUserLButtonDown(WPARAM wParam, LPARAM lParam)
{
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
// 		::PostMessage(st_handler.hWnd, WM_MAINFRAME_WORK, 1000, 0);
	...
	{ // "Jog (-)" 버튼이 눌린 경우...
		if(m_n_move_mode == 0)
		{
			...
			COMI.Set_MotSpeed(MOT_SPD_JOG, m_n_axis, cmSMODE_KEEP, st_motor[m_n_axis].md_spd_jog, COMI.md_spd_vel[m_n_axis][1], COMI.md_spd_vel[m_n_axis][2]);		// 축의 속도를 변경한다.
...
LONG CDialog_Motor_Axis_3::OnUserLButtonUp(WPARAM wParam, LPARAM lParam)
{	
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
void CDialog_Motor_Axis_3::OnBtnHome() 
{
	CString strTmp;
...
void CDialog_Motor_Axis_3::OnBtnApply() 
{
	Data_HistoryLog();
	Data_Apply();
}
