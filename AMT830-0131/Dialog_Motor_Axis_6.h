#if !defined(AFX_DIALOG_MOTOR_AXIS_6_H__0150F58C_B769_4600_8357_A46ED13409F7__INCLUDED_)
#define AFX_DIALOG_MOTOR_AXIS_6_H__0150F58C_B769_4600_8357_A46ED13409F7__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Dialog_Motor_Axis_6.h : header file
//
...
class CDialog_Motor_Axis_6 : public CDialog
{
public:
...
public:
	...
	void	Init_Label();
	void	Init_Button();
	CDialog_Motor_Axis_6(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDialog_Motor_Axis_6)
	enum { IDD = IDD_MOTOR_AXIS_6 };
	...
	//{{AFX_VIRTUAL(CDialog_Motor_Axis_6)
	protected:
...
#endif // !defined(AFX_DIALOG_MOTOR_AXIS_6_H__0150F58C_B769_4600_8357_A46ED13409F7__INCLUDED_)
