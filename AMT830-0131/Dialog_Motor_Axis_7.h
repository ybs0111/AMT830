#if !defined(AFX_DIALOG_MOTOR_AXIS_7_H__8152BDAA_0E79_4280_83A5_37D06D3F600B__INCLUDED_)
#define AFX_DIALOG_MOTOR_AXIS_7_H__8152BDAA_0E79_4280_83A5_37D06D3F600B__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Dialog_Motor_Axis_7.h : header file
//
...
class CDialog_Motor_Axis_7 : public CDialog
{
public:
...
public:
	...
	void	Init_Label();
	void	Init_Button();
	CDialog_Motor_Axis_7(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDialog_Motor_Axis_7)
	enum { IDD = IDD_MOTOR_AXIS_7 };
	...
	//{{AFX_VIRTUAL(CDialog_Motor_Axis_7)
	protected:
...
#endif // !defined(AFX_DIALOG_MOTOR_AXIS_7_H__8152BDAA_0E79_4280_83A5_37D06D3F600B__INCLUDED_)
