// Dialog_Motor_Axis_10.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_10 dialog
#define TM_STATUS_CHECK		100
#define TM_POSITION_CHECK	200
#define TM_HOME_CHECK		300
#define TM_MOVE_CHECK		400
#define AXIS_NUM			9
CDialog_Motor_Axis_10::CDialog_Motor_Axis_10(CWnd* pParent /*=NULL*/)
	: CDialog(CDialog_Motor_Axis_10::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialog_Motor_Axis_10)
...
void CDialog_Motor_Axis_10::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialog_Motor_Axis_10)
...
BEGIN_MESSAGE_MAP(CDialog_Motor_Axis_10, CDialog)
	//{{AFX_MSG_MAP(CDialog_Motor_Axis_10)
	ON_WM_TIMER()
	ON_WM_PAINT()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_10 message handlers

void CDialog_Motor_Axis_10::OnTimer(UINT nIDEvent) 
{
...
BOOL CDialog_Motor_Axis_10::OnInitDialog() 
{
...
void CDialog_Motor_Axis_10::Init_Group()
{
...
void CDialog_Motor_Axis_10::Init_Button()
{
	short	shBtnColor = 30;
	CString strTmp;
...
void CDialog_Motor_Axis_10::Init_Label()
{

}

void CDialog_Motor_Axis_10::Init_Radio()
{

}

void CDialog_Motor_Axis_10::Init_Digit()
{

}

void CDialog_Motor_Axis_10::Init_Grid_Pos()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_10::Data_Apply()
{
	int i;
...
void CDialog_Motor_Axis_10::Data_Backup()
{
	int i;
...
int CDialog_Motor_Axis_10::Data_Comparison()
{
	int i;
...
void CDialog_Motor_Axis_10::Data_HistoryLog()
{
	int i;
	CString str_msg;
...
void CDialog_Motor_Axis_10::Data_Recovery()
{
	int i;
...
void CDialog_Motor_Axis_10::Data_Init()
{
	int i;
...
void CDialog_Motor_Axis_10::MotorStatusCheck()
{
...
void CDialog_Motor_Axis_10::MotorPositionCheck()
{
...
void CDialog_Motor_Axis_10::OnCellClick(WPARAM wParam, LPARAM lParam)
{
...
void CDialog_Motor_Axis_10::MotorMoveStepClear()
{
...
void CDialog_Motor_Axis_10::MotorCompletion(int nrow, int ncol)
{
	m_grid_motor_pos = (TSpread*)GetDlgItem(IDC_CUSTOM_MOTOR_POS);
...
int CDialog_Motor_Axis_10::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_10::MotorMovingExcution()
{
...
void CDialog_Motor_Axis_10::OnButtonControl(BOOL b_flag)
{

}

void CDialog_Motor_Axis_10::OnPaint() 
{
...
void CDialog_Motor_Axis_10::Init_Grid_Info()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_10::OnDestroy() 
{
	Data_HistoryLog();
	Data_Apply();
...
void CDialog_Motor_Axis_10::OnBtnEmg() 
{
...
// **********************************************************************
LONG CDialog_Motor_Axis_10::OnUserLButtonDown(WPARAM wParam, LPARAM lParam)
{
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
LONG CDialog_Motor_Axis_10::OnUserLButtonUp(WPARAM wParam, LPARAM lParam)
{	
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
void CDialog_Motor_Axis_10::OnBtnHome() 
{
	CString strTmp;
...
void CDialog_Motor_Axis_10::OnBtnApply() 
{
	Data_HistoryLog();
	Data_Apply();
}
