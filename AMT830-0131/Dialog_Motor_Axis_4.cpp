// Dialog_Motor_Axis_4.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_4 dialog
#define TM_STATUS_CHECK		100
#define TM_POSITION_CHECK	200
#define TM_HOME_CHECK		300
#define TM_MOVE_CHECK		400
#define AXIS_NUM			3
CDialog_Motor_Axis_4::CDialog_Motor_Axis_4(CWnd* pParent /*=NULL*/)
	: CDialog(CDialog_Motor_Axis_4::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialog_Motor_Axis_4)
...
void CDialog_Motor_Axis_4::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialog_Motor_Axis_4)
...
BEGIN_MESSAGE_MAP(CDialog_Motor_Axis_4, CDialog)
	//{{AFX_MSG_MAP(CDialog_Motor_Axis_4)
	ON_WM_TIMER()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_4 message handlers
/*
void CDialog_Motor_Axis_4::OnTimer(UINT nIDEvent) 
{
...
*/
BOOL CDialog_Motor_Axis_4::OnInitDialog() 
{
...
void CDialog_Motor_Axis_4::Init_Group()
{
...
void CDialog_Motor_Axis_4::Init_Button()
{
	short	shBtnColor = 30;
	CString strTmp;

	if (m_str_axis_name == "Unloader_Tray_Transfer_Z")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
///////////////////////// 20120716
	else if (m_str_axis_name == "Vision2_Y")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_DN);
	}
	else if (m_str_axis_name == "S_Rbt_Z" || m_str_axis_name == "M_Clamp_Rbt_Z")// || m_str_axis_name == "Loader_Transfer_X")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
	else if (m_str_axis_name == "W_Buffer_4")// || m_str_axis_name == "Loader_Transfer_X")
	{
...
void CDialog_Motor_Axis_4::Init_Label()
{

}

void CDialog_Motor_Axis_4::Init_Radio()
{

}

void CDialog_Motor_Axis_4::Init_Digit()
{

}

void CDialog_Motor_Axis_4::Init_Grid_Pos()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_4::Data_Apply()
{
	int i;
...
void CDialog_Motor_Axis_4::Data_Backup()
{
	int i;
...
int CDialog_Motor_Axis_4::Data_Comparison()
{
	int i;
...
void CDialog_Motor_Axis_4::Data_HistoryLog()
{
	int i;
	CString str_msg;
...
void CDialog_Motor_Axis_4::Data_Recovery()
{
	int i;
...
void CDialog_Motor_Axis_4::Data_Init()
{
	int i;
...
void CDialog_Motor_Axis_4::MotorStatusCheck()
{
...
void CDialog_Motor_Axis_4::MotorPositionCheck()
{
...
void CDialog_Motor_Axis_4::OnCellClick(WPARAM wParam, LPARAM lParam)
{
...
void CDialog_Motor_Axis_4::MotorMoveStepClear()
{
...
void CDialog_Motor_Axis_4::MotorCompletion(int nrow, int ncol)
{
	m_grid_motor_pos = (TSpread*)GetDlgItem(IDC_CUSTOM_MOTOR_POS);
...
int CDialog_Motor_Axis_4::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_4::MotorMovingExcution()
{
...
//	}
	...
	switch(m_n_move_step)
	{
		...
		case 20 :
			if (st_handler.cwnd_list != NULL)
			{
				//st_msg.mstr_normal_msg = _T("[%s] Motor completed transfer.", m_str_cmd_motor);
		...
		case 110 :
			if (st_handler.cwnd_list != NULL)
			{  // 리스트 바 화면 존재
				//st_msg.mstr_normal_msg = _T("[%s] Motor shut down during transfer.", m_str_cmd_motor);
				sprintf(st_msg.c_normal_msg, "[%s] Motor shut down during transfer.", m_str_cmd_motor);
				st_handler.cwnd_list->PostMessage(WM_LIST_DATA, 0, NORMAL_MSG);  // 동작 완료 출력 요청
			}
...
void CDialog_Motor_Axis_4::OnButtonControl(BOOL b_flag)
{
	
}


void CDialog_Motor_Axis_4::OnPaint() 
{
...
void CDialog_Motor_Axis_4::Init_Grid_Info()
{
	int   i, j;
	CString str_tmp;
...
/*
BOOL CDialog_Motor_Axis_4::DestroyWindow() 
{
...
void CDialog_Motor_Axis_4::OnDestroy() 
{
	Data_HistoryLog();
	Data_Apply();
...
void CDialog_Motor_Axis_4::OnBtnEmg() 
{
...
// **********************************************************************
LONG CDialog_Motor_Axis_4::OnUserLButtonDown(WPARAM wParam, LPARAM lParam)
{
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
LONG CDialog_Motor_Axis_4::OnUserLButtonUp(WPARAM wParam, LPARAM lParam)
{	
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
void CDialog_Motor_Axis_4::OnBtnHome() 
{
	CString strTmp;
...
void CDialog_Motor_Axis_4::OnBtnApply() 
{
	Data_HistoryLog();
	Data_Apply();
}
