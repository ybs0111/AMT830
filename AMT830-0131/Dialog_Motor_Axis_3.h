#if !defined(AFX_DIALOG_MOTOR_AXIS_3_H__D5D26446_D78B_4288_A6FE_7A97C3440166__INCLUDED_)
#define AFX_DIALOG_MOTOR_AXIS_3_H__D5D26446_D78B_4288_A6FE_7A97C3440166__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Dialog_Motor_Axis_3.h : header file
//
...
class CDialog_Motor_Axis_3 : public CDialog
{
public:
...
public:
	...
	void	Init_Label();
	void	Init_Button();
	CDialog_Motor_Axis_3(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDialog_Motor_Axis_3)
	enum { IDD = IDD_MOTOR_AXIS_3 };
	...
	//{{AFX_VIRTUAL(CDialog_Motor_Axis_3)
	protected:
...
#endif // !defined(AFX_DIALOG_MOTOR_AXIS_3_H__D5D26446_D78B_4288_A6FE_7A97C3440166__INCLUDED_)
