// Dialog_Motor_Axis_8.cpp : implementation file
//
...
#define AXIS_NUM			7
CDialog_Motor_Axis_8::CDialog_Motor_Axis_8(CWnd* pParent /*=NULL*/)
	: CDialog(CDialog_Motor_Axis_8::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDialog_Motor_Axis_8)
...
void CDialog_Motor_Axis_8::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDialog_Motor_Axis_8)
...
BEGIN_MESSAGE_MAP(CDialog_Motor_Axis_8, CDialog)
	//{{AFX_MSG_MAP(CDialog_Motor_Axis_8)
	ON_WM_TIMER()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CDialog_Motor_Axis_8 message handlers
/*
void CDialog_Motor_Axis_8::OnTimer(UINT nIDEvent) 
{
...
*/
BOOL CDialog_Motor_Axis_8::OnInitDialog() 
{
...
void CDialog_Motor_Axis_8::Init_Group()
{
...
void CDialog_Motor_Axis_8::Init_Button()
{
	short	shBtnColor = 30;
	CString strTmp;
...
void CDialog_Motor_Axis_8::Init_Label()
{

}

void CDialog_Motor_Axis_8::Init_Radio()
{

}

void CDialog_Motor_Axis_8::Init_Digit()
{

}

void CDialog_Motor_Axis_8::Init_Grid_Pos()
{
	int   i, j;
	CString str_tmp;
...
void CDialog_Motor_Axis_8::Data_Apply()
{
	int i;
...
void CDialog_Motor_Axis_8::Data_Backup()
{
	int i;
...
int CDialog_Motor_Axis_8::Data_Comparison()
{
	int i;
...
void CDialog_Motor_Axis_8::Data_HistoryLog()
{
	int i;
	CString str_msg;
...
void CDialog_Motor_Axis_8::Data_Recovery()
{
	int i;
...
void CDialog_Motor_Axis_8::Data_Init()
{
	int i;
...
void CDialog_Motor_Axis_8::MotorStatusCheck()
{
...
void CDialog_Motor_Axis_8::MotorPositionCheck()
{
...
void CDialog_Motor_Axis_8::OnCellClick(WPARAM wParam, LPARAM lParam)
{
...
void CDialog_Motor_Axis_8::MotorMoveStepClear()
{
...
void CDialog_Motor_Axis_8::MotorCompletion(int nrow, int ncol)
{
	m_grid_motor_pos = (TSpread*)GetDlgItem(IDC_CUSTOM_MOTOR_POS);
...
int CDialog_Motor_Axis_8::MotorHomingExcution()
{
...
int CDialog_Motor_Axis_8::MotorMovingExcution()
{
...
void CDialog_Motor_Axis_8::OnButtonControl(BOOL b_flag)
{
	
}


void CDialog_Motor_Axis_8::OnPaint() 
{
...
void CDialog_Motor_Axis_8::Init_Grid_Info()
{
	int   i, j;
	CString str_tmp;
...
/*
BOOL CDialog_Motor_Axis_8::DestroyWindow() 
{
...
void CDialog_Motor_Axis_8::OnDestroy() 
{
	Data_HistoryLog();
	Data_Apply();
...
void CDialog_Motor_Axis_8::OnBtnEmg() 
{
...
// **********************************************************************
LONG CDialog_Motor_Axis_8::OnUserLButtonDown(WPARAM wParam, LPARAM lParam)
{
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
LONG CDialog_Motor_Axis_8::OnUserLButtonUp(WPARAM wParam, LPARAM lParam)
{	
	CDialog_Message msg_dlg;
	CString strTmp;
	int		nRet;
...
void CDialog_Motor_Axis_8::OnBtnHome() 
{
	CString strTmp;
...
void CDialog_Motor_Axis_8::OnBtnApply() 
{
	Data_HistoryLog();
	Data_Apply();	
}
